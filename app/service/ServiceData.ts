...
export const services: Service[] = [
    ...
    },
    {
        ...
        icon: Zap,
        description: "Energy conservation is the practice of reducing energy consumption through efficient energy management and the optimal use of resources. This can be achieved by using energy more efficiently to deliver the same level of performance or by minimizing unnecessary energy usage. At Limbaja Energy, we provide Energy Conservation Services in Gujarat for industries across Gujarat and India, offering energy-saving solutions, energy efficiency consulting, and industrial energy optimization services. Our expert team helps businesses reduce operating costs, improve equipment performance, and achieve long-term energy efficiency through practical and sustainable solutions.",
    ...
    },
    {
        ...
        icon: Activity,
        description: "Harmonic analysis is a technique used to study and analyze the harmonic components in electrical power systems. It helps identify the presence and impact of harmonic currents and voltages, which are integer multiples of the fundamental frequency and are commonly generated by non-linear loads such as power electronics, variable speed drives, and certain lighting systems.\n\nAt Limbaja Energy, we provide Harmonic Analysis Services in Gujarat for industries across Gujarat and India. Our Power Quality Analysis and Electrical Harmonic Study Services help identify harmonic distortion, improve power quality, protect sensitive equipment, and enhance the reliability and efficiency of electrical systems. We also recommend effective harmonic mitigation solutions to reduce power losses and ensure stable system performance.",
    ...
    },
    {
        ...
        icon: Wind,
        description: "A compressed air audit helps identify system inefficiencies, reduce energy costs, and improve the overall performance of compressed air systems. Many industrial air compressors operate inefficiently due to air leaks, artificial demand, pressure losses, and incorrect operating pressures, resulting in unnecessary energy consumption and increased operating costs.\n\nAt Limbaja Energy, we provide Compressor Audit Services in Gujarat for industries across Gujarat and India. Our Compressed Air Energy Audit Services include compressor efficiency assessments, performance analysis, and compressed air system optimization to identify energy-saving opportunities, improve system reliability, reduce power consumption, and maximize the efficiency of industrial compressed air systems.",
    ...
    },
    {
        ...
        icon: Search,
        description: "We provide Compressed Air Leakage Audit Services for industries across Gujarat and India to detect air leaks, reduce energy losses, and improve compressor system efficiency. Our Compressed Air Leakage Audit Services in Gujarat, Compressed Air Audit Services, and Industrial Air Leakage Audit Services help optimize compressed air systems, lower operating costs, and maximize overall energy savings. As a trusted provider of Leakage Audit Services in Gujarat and India, we deliver accurate leak detection and practical solutions for enhanced system performance. Have a look!",
    ...
    },
    {
        ...
        icon: Settings,
        description: "Performance testing is essential for evaluating the efficiency, reliability, and operational performance of power plants. At Limbaja Energy, we provide Power Plant Audit Services in Gujarat for industries across Gujarat and India, conducting performance testing of Captive, Cogeneration, Waste Heat Recovery, Thermal, and Gas Power Plants in accordance with the respective ASME PTC Codes. Our Power Plant Energy Audit Services help improve plant efficiency, reduce energy losses, optimize power generation, and enhance overall operational performance.",
    ...
    },
    {
        ...
        icon: Thermometer,
        description: "Studies are undertaken to determine the efficiency of thermal energy generation, distribution, and utilization across industrial processes. Boiler efficiency tests are carried out to evaluate the steam generation-to-fuel ratio, helping identify opportunities to improve fuel efficiency and reduce energy losses.\n\nAt Limbaja Energy, we provide Boiler and Furnace Audit Services in Gujarat for industries across Gujarat and India. Our Boiler Efficiency Audits, Furnace Energy Audits, and Combustion Efficiency Analysis help optimize thermal performance, reduce fuel consumption, improve steam generation efficiency, and enhance overall plant productivity through reliable and cost-effective energy solutions.",
    ...
    },
    {
        ...
        icon: Droplets,
        description: "Accurate flow measurements are critical for utility calculations, process control applications, and efficient industrial operations. Flow measurement is also valuable for monitoring, analyzing, and troubleshooting internal processes at various stages, helping industries improve system performance and operational efficiency.\n\nFlow measurement technology can accurately measure the flow of virtually any fluid, including liquids, gases, and steam, regardless of the flow direction (bi-directional) and across an extremely wide measuring range. Due to its practical advantages, external flow measurement using clamp-on ultrasonic transducers has become a standard measurement technique across a wide range of industries and applications.\n\nAt Limbaja Energy, we provide Flow Measurement Services in Gujarat for industries across Gujarat and India. Our Industrial Flow Measurement Services use advanced clamp-on ultrasonic technology that can be installed within minutes without shutting down operations, eliminating costly downtime. This technology works efficiently with gases at both high and low pressures in metal pipes and most other pipe materials. Our Flow Measurement Audit Services, Process Flow Analysis Services, and Flow Meter Calibration Services help industries improve measurement accuracy, optimize processes, enhance energy efficiency, and support reliable industrial operations.",
    ...
    },
    {
        ...
        icon: Activity,
        description: "Heat and mass balance is a critical aspect of process engineering, used extensively in the design and analysis of process plants. These calculations ensure that the energy and material inputs and outputs in a system are accurately accounted for, helping to optimize efficiency, safety, and cost-effectiveness in industrial operations. At Limbaja Energy, we provide Process Heat Optimization Services in Gujarat for industries across Gujarat and India, including Process Heat Audit Services, Thermal Energy Audit Services, Furnace Energy Audit Services, Boiler Efficiency Audit Services, and Waste Heat Recovery Services. Our solutions help improve thermal efficiency, reduce fuel consumption, and enhance overall process performance. Have a look!",
    ...
    },
    {
        ...
        icon: Wind,
        description: "Cooling towers play a vital role in industrial and commercial applications by efficiently removing excess heat from air conditioning systems and process equipment while maximizing water reuse. They are typically designed to operate under maximum process loads and the most demanding ambient conditions.\n\nAt Limbaja Energy, we provide Cooling Tower Audit Services in Gujarat for industries across Gujarat and India. Our Cooling Tower Performance Assessment and Cooling Tower Efficiency Audit Services help identify operational inefficiencies, optimize pump and fan performance, and improve overall cooling tower efficiency. Through effective maintenance and system optimization, businesses can reduce energy and water consumption while achieving potential savings of 20–25% by eliminating excess capacity and improving operational performance.",
    ...
    },
    {
        ...
        icon: Thermometer,
        description: "The performance assessment of a chiller plant involves calculating the cooling capacity delivered by the system and measuring the power consumed by the unit. Key performance indicators such as Specific Power Consumption (SPC – kW/TR) and Energy Efficiency Ratio (EER) are used to evaluate the electrical energy input against the cooling output delivered by the system.\n\nAt Limbaja Energy, we provide Chiller Audit Services in Gujarat for industries across Gujarat and India. Our Chiller Performance Assessment and Chiller Energy Audit Services include measuring critical parameters such as flow rate, temperature, and power on both the chilled water and refrigeration sides of the system. These assessments help improve chiller efficiency, reduce energy consumption, optimize HVAC performance, and lower operating costs.",
    ...
    },
    {
        ...
        icon: Zap,
        description: "Lighting is an essential service in every industry, playing a significant role in ensuring safe and productive working environments. The power consumption of industrial lighting typically varies between 2% and 10% of the total electricity usage, depending on the type of industry and its operational requirements. Continuous innovation and advancements in lighting technology have created significant opportunities for improving energy efficiency and reducing operating costs.\n\nAt Limbaja Energy, we provide Lighting Energy Audit Services in Gujarat for industries across Gujarat and India. Our Industrial Lighting Audit Services include lighting efficiency assessments, LED lighting audits, and energy-saving recommendations to optimize lighting systems, reduce electricity consumption, improve illumination quality, and enhance overall energy performance. Our energy-efficient lighting solutions help industries achieve long-term cost savings while supporting sustainable operations.",
    ...
    },
    {
        ...
        icon: Thermometer,
        description: "Thermography Study is used for predictive maintenance and early fault detection in electrical and mechanical systems. Many problems begin with an increase in temperature, and infrared thermography allows potential issues to be identified before they lead to equipment failure or costly downtime. At Limbaja Energy, we provide Thermography Services in Gujarat for industries across Gujarat and India, including Infrared Thermography Services, Electrical Thermography Inspections, Thermal Imaging Inspection Services, and Electrical Panel Thermography. Our thermal imaging inspections help improve equipment reliability, enhance safety, support preventive maintenance, and reduce unplanned breakdowns without disrupting operations.",
    ...
    },
    {
        ...
        icon: Droplets,
        description: "A steam trap is a mechanical valve that separates condensate from steam and returns it to the boiler, ensuring efficient steam system operation. Over time, steam traps can become clogged, leak, or fail, resulting in steam losses, higher energy consumption, and reduced system efficiency.\n\nAt Limbaja Energy, we provide Steam Trap Audit Services in Gujarat for industries across Gujarat and India. Our Steam Trap Survey, Testing, Inspection, and Steam System Energy Audit Services help identify faulty steam traps, improve steam distribution, reduce energy losses, and optimize overall steam system performance. With a properly maintained steam trap system, industries can reduce energy costs by 10–15% while improving operational reliability and efficiency.",
    ...
    },
    {
        ...
        icon: Activity,
        description: "All pumps have a characteristic or performance curve that defines the relationship between flow rate and total head. These performance curves help evaluate pump efficiency, operating conditions, and overall system performance, ensuring the pump operates within its optimal range.\n\nAt Limbaja Energy, we provide Pump Audit Services in Gujarat for industries across Gujarat and India. Our Pumping System Audit Services include pump efficiency assessments, performance analysis, and energy audits to identify inefficiencies, optimize system operation, reduce power consumption, and improve the reliability of industrial pumping systems.",
    ...
    },
    {
        ...
        title: "Fan Study",
        icon: Wind,
        description: "Industrial fans play a vital role in ventilation, cooling, and process applications, making their performance essential for efficient plant operations. Field performance testing helps evaluate fan efficiency by measuring airflow, pressure, temperature, and electrical power consumption to identify opportunities for energy savings and improved system performance.\n\nAt Limbaja Energy, we provide Industrial Fan Audit Services in Gujarat for industries across Gujarat and India. Our fan audits include the measurement of airflow, head, temperature on the fan side, and electrical motor kW input on the motor side. Air velocity is accurately measured using an anemometer, and the airflow is calculated by multiplying the air velocity by the inlet area. Our Fan Efficiency Assessment, Industrial Fan Energy Audit, and Ventilation System Energy Audit Services help optimize fan performance, reduce energy consumption, and improve the overall efficiency of industrial ventilation systems.",
    ...
    },
    {
        ...
        icon: Globe,
        description: "We provide Carbon Footprint Assessment Services for industries and organizations across Gujarat and India. Our services include carbon footprint assessment, carbon emission assessment, carbon verification, carbon accounting, and sustainability consulting to help businesses measure, manage, and reduce their environmental impact. We have successfully validated numerous UCR projects, including Wind, Solar, Biomass, and Hydro, supporting organizations in achieving their carbon neutrality and sustainability goals.",
    ...
    },
    {
        ...
        icon: AlertTriangle,
        description: "Arc Flash Studies are essential for identifying electrical hazards and ensuring the safety of personnel and equipment. A detailed arc flash assessment helps determine incident energy levels, evaluate system risks, and recommend appropriate protective measures to maintain a safe working environment.\n\nAt Limbaja Energy, we provide Arc Flash Study Services in Gujarat for industries across Gujarat and India. Our comprehensive safety assessments include ETAP modelling, short circuit studies, arc flash risk assessment, and electrical system safety analysis. These services help improve electrical safety, ensure regulatory compliance, minimize operational risks, and protect critical electrical infrastructure.",
    ...
    },
    {
        ...
        icon: PieChart,
        description: "We provide Energy Meter Calibration Services at industrial plants across Gujarat and India to ensure accurate energy measurement and reliable system performance. At Limbaja Energy, our Energy Meter Calibration Services include electrical meter calibration, power meter testing, and industrial instrument calibration using advanced testing equipment. Accurate calibration helps improve measurement precision, supports energy audits, ensures compliance with industry standards, and enables better energy management for efficient plant operations.",
