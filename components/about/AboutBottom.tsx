    ...
    return (
        <section className="py-24 bg-[#0f172a] relative overflow-hidden flex items-center justify-center text-center">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <Quote className="text-secondary/20 w-20 h-20 mx-auto mb-6" />
                    <span className="text-sm font-bold tracking-[0.3em] text-primary uppercase mb-6 block">Our Vision</span>
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-white leading-tight tracking-wide font-sans">
                        "To enable industries to grow <span className="font-bold text-white">profitably</span> while conserving energy resources and contributing to a <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">sustainable future</span>."
                    </h2>
                </motion.div>
            </div>
        </section>
                ...
                <div className="relative overflow-hidden rounded-3xl bg-primary shadow-2xl">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-12 md:p-16 gap-8 text-center md:text-left">
                        ...
                        <div className="shrink-0">
                            <Link
                                href="/contact-us"
                                className="group inline-flex items-center gap-2 bg-white text-primary px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                            >
